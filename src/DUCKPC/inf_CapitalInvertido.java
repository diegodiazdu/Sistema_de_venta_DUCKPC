...
public class inf_CapitalInvertido extends javax.swing.JFrame {

    Conexion con = new Conexion();
    Connection cn = con.conectar();

    public inf_CapitalInvertido() {
        initComponents();
        listarTabla();
        /*##### LLenar combobox #####*/
    ...
    private void initComponents() {
        ...
        tablaInversiones.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "N° Folio", "Proveedor", "Fecha", "Total Bruto", "Total Neto"
            }
        ));
        jScrollPane1.setViewportView(tablaInversiones);

        jLabel3.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabel3.setText("Total invertido:");
        ...
        jLabel6.setText("INFORME DE INVERSIONES");
    ...
    private void btnExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcelActionPerformed
        if (tablaVacia(tablaInversiones)) {
            ...
            try {
                ...
                Logger.getLogger(inf_CapitalInvertido.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(inf_CapitalInvertido.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new inf_CapitalInvertido().setVisible(true);
            }
        });
    }
    ...
    public void listarTabla() {
        ...
        String[] titulos = {"N° Folio", "Proveedor", "Fecha", "Total Bruto", "Total Neto"};
        String[] registros = new String[6];

        DefaultTableModel modelo = new DefaultTableModel(null, titulos);

        String opSelect = ("SELECT com_nofolio, proveedor.prov_nombre, com_fecha, com_total_bruto, com_total_neto FROM proveedor, compra "
                         + "WHERE proveedor.prov_id = compra.com_prov_id");
        ...
        try {
            ...
            while (rs.next()) {
                ...
                registros[0] = rs.getString("com_nofolio");
                registros[1] = rs.getString("proveedor.prov_nombre");
                registros[2] = rs.getString("com_fecha");
                registros[3] = rs.getString("com_total_bruto");
                registros[4] = rs.getString("com_total_neto");
    ...
    public void listarTablaFecha() {
        ...
        String opSelect = ("SELECT com_nofolio, proveedor.prov_nombre, com_fecha, com_total_bruto, com_total_neto FROM proveedor, compra "
                + "WHERE proveedor.prov_id = compra.com_prov_id AND com_fecha BETWEEN '"+fechaInicio+"' AND '"+fechaFinal+"'");
    ...
    public ArrayList<String> llenarComboInicio() {
        ...
        String opSelect = "SELECT DISTINCT COM_FECHA FROM COMPRA";
