...
public class inf_gananciasVentas extends javax.swing.JFrame {

    Conexion con = new Conexion();
    Connection cn = con.conectar();

    public inf_gananciasVentas() {
        initComponents();
        listarTabla();
    ...
    private void initComponents() {
        ...
        tablaInversiones.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Cliente", "Vendedor", "Fecha", "Monto"
            }
        ));
        ...
        btnSemana.setText("Ventas de la ultima semana");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel2)
                    .addComponent(jbFechaFinal, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcelActionPerformed
        if (tablaVacia(tablaInversiones)) {
            ...
            try {
                ...
                Logger.getLogger(inf_gananciasVentas.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(inf_gananciasVentas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new inf_gananciasVentas().setVisible(true);
            }
        });
    }
    ...
    public void listarTabla() {
        ...
        String[] titulos = {"ID", "Cliente", "Vendedor", "Fecha", "Monto"};
        ...
        String opSelect = ("SELECT ven_id, cliente.cli_nombre, usuario.usu_name, ven_fecha, ven_monto FROM venta,cliente,usuario "
                         + "WHERE cliente.cli_rut = venta.ven_cli_rut AND usuario.usu_id = venta.ven_usu_id AND ven_fecha BETWEEN "
        ...
        try {
            ...
            while (rs.next()) {
                ...
                registros[0] = rs.getString("ven_id");
                registros[1] = rs.getString("cliente.cli_nombre");
                registros[2] = rs.getString("usuario.usu_name");
                registros[3] = rs.getString("ven_fecha");
                registros[4] = rs.getString("ven_monto");
    ...
    public void listar7dias() {
        ...
        String opSelect = ("SELECT ven_id, cliente.cli_nombre, usuario.usu_name, ven_fecha, ven_monto FROM venta,cliente,usuario"
                         + " WHERE cliente.cli_rut = venta.ven_cli_rut AND usuario.usu_id = venta.ven_usu_id AND VEN_FECHA <= NOW() "
                         + "AND VEN_FECHA >= date_add(NOW(), INTERVAL -7 DAY)");
    ...
    public ArrayList<String> llenarComboInicio() {
        ...
        String opSelect = "SELECT DISTINCT VEN_FECHA FROM VENTA";
